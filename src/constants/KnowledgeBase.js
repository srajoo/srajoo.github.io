export const items = [
    ...
    {
        title: 'Bias Detection Classifier',
        icon: 'Security',
        url: 'https://drive.google.com/drive/folders/1sHiG7ifQJah_QYpDMLKwSfov6gVJQTTh'
    },
    {
    ...
    },
    {
        ...
        icon: 'ShowChart',
        url: 'https://srajoo.github.io/CanvasAPI-react-typescript/'
    },
    {
        title: 'Celebsum - Text Generator',
        icon: 'TextFields',
